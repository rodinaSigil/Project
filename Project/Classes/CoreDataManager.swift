...
class CoreDataManager
{
    ...
    func addItem(key: Int, title: String, subtitle: String, imgurl: String, detail: String)
    {
    ...
    func synchronizateData(data: [TableStructure])
    {
	     self?.mergeChangesFromServer(serverList: data)
    }
